...
NewProjectDialog::NewProjectDialog() :
		m_label1("选择文件夹:"), m_label2("参数设置:"), m_label3("项目名称:"), m_folder_chooserbtn(
				"选择一个文件夹", Gtk::FILE_CHOOSER_ACTION_SELECT_FOLDER), m_option_panel_hbox(
				false, 0) {
...
void NewProjectDialog::createUI() {
	...
	main->pack_start(this->m_option_panel_hbox, false, false, 5);
	this->m_label3.set_alignment(Gtk::ALIGN_LEFT, Gtk::ALIGN_CENTER);
	main->pack_start(this->m_label3, false, false, 0);
